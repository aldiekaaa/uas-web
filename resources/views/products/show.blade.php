...
<div class="flex justify-between py-10">
    ...
    <a class="py-1 px-5 bg-blue-500 rounded-lg text-white" href="{{ route('products.index') }}">Back</a>
</div>

<div class="w-full bg-white border border-gray-200 rounded-lg shadow">
    <div class="flex justify-center rounded-xl">
        <img class="my-14 rounded-2xl w-[500px] shadow-lg" src="/image/{{ $product->image }}" alt="product image" />
    </div>
    <div class="px-5 pb-5">
        ...
        <a href="{{ route('products.edit',$product->id) }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Edit Product</a>
    </div>
</div>
@endsection
